...
class TestAuthorizationServiceEdgeCases:
    ...
    def test_authorize_with_inactive_roles(
        self, authorization_service, mock_repositories, sample_context
    ):
    ...
    def test_authorize_with_inactive_permissions(
        ...
        mock_repositories["role_repo"].get_role_hierarchy.return_value = [active_role]
    ...
    def test_authorize_with_inactive_policies(
        ...
        # mock_repositories["role_repo"].get_role_hierarchy.return_value = [role]
    ...
    def test_authorize_with_none_resource_id(
        self, authorization_service, mock_repositories, mock_policy_evaluation_service
    ):
    ...
    def test_authorize_with_none_organization_id(
        self, authorization_service, mock_repositories
    ):
        ...
        mock_repositories["role_repo"].get_role_hierarchy.return_value = [system_role]
        ...
        mock_repositories["role_repo"].get_user_roles.assert_called_with(
    ...
    def test_authorize_with_recursive_policy_references(
        ...
        recursive_policy = Policy.create(
            ...
            action="read",
            conditions=[
                PolicyCondition(attribute="user.id", operator="eq", value="{{user.id}}")
            ],  # Self-reference
            organization_id=sample_context.organization_id,
            created_by=uuid4(),
        )
    ...
    def test_authorize_with_extremely_large_number_of_policies(
        ...
        for i in range(100):
            policy = Policy.create(
                ...
                effect=PolicyEffect.ALLOW if i % 2 == 0 else "deny",
                resource_type="document",
                action="read",
                conditions=[],
                organization_id=sample_context.organization_id,
    ...
    def test_authorize_timing_consistency(
        self, mock_time, authorization_service, mock_repositories, sample_context
    ):
