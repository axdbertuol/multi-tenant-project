...
class TestAuthorizationServiceRoleInheritance:
    ...
    def test_authorize_with_inherited_permissions_rh_example(
        ...
        mock_repositories['resource_repo'].get_by_resource_id.return_value = None
    ...
    def test_authorize_with_deep_inheritance_hierarchy(
        ...
        basic_perm = Permission.create("basic_access", "Basic access", PermissionAction.READ, "document")
        supervisor_perm = Permission.create("supervisor_access", "Supervisor access", PermissionAction.UPDATE, "document")
        manager_perm = Permission.create("manager_access", "Manager access", PermissionAction.DELETE, "document")
    ...
    def test_authorize_with_broken_inheritance_chain(
        ...
        orphaned_perm = Permission.create("orphaned_access", "Orphaned access", PermissionAction.READ, "document")
    ...
    def test_authorize_with_inactive_parent_role(
        ...
        parent_perm = Permission.create("parent_access", "Parent access", PermissionAction.UPDATE, "document")
        child_perm = Permission.create("child_access", "Child access", PermissionAction.READ, "document")
        ...
        context = AuthorizationContext.create(
            user_id=user_id,
            resource_type="document",
            action="update",  # Parent's permission
            organization_id=organization_id
        )
    ...
    def test_authorize_with_circular_inheritance_prevention(
        ...
        perm_a = Permission.create("access_a", "Access A", PermissionAction.READ, "resource_a")
        perm_b = Permission.create("access_b", "Access B", PermissionAction.READ, "resource_b")
    ...
    def test_authorize_with_multiple_inheritance_paths(
        ...
        base_perm = Permission.create("base_access", "Base access", PermissionAction.READ, "document")
        admin_perm = Permission.create("admin_access", "Admin access", PermissionAction.UPDATE, "document")
        special_perm = Permission.create("special_access", "Special access", PermissionAction.EXECUTE, "system")
    ...
    def test_authorize_inheritance_performance_with_many_levels(
        ...
        root_perm = Permission.create("access_0", "Level 0 access", PermissionAction.READ, "level_0")
        ...
        for i in range(1, 10):
            ...
            perm = Permission.create(f"access_{i}", f"Level {i} access", PermissionAction.READ, f"level_{i}")
