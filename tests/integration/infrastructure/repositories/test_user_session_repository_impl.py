...
class TestUserSessionRepositoryImpl:
    ...
    @pytest.mark.asyncio
    async def test_create_session(self, session_repository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_session_token(self, session_repository):
        ...
        # Act
        retrieved_session = await session_repository.get_by_session_token("unique_token_123")
    ...
    @pytest.mark.asyncio
    async def test_get_by_session_token_not_found(self, session_repository):
        """Test getting session by non-existent token."""
        # Act
        result = await session_repository.get_by_session_token("non_existent_token")
        
        # Assert
        assert result is None
    
    @pytest.mark.asyncio
    async def test_get_active_sessions_by_user_id(self, session_repository):
        ...
        await session_repository.create(active_session1)
        await session_repository.create(active_session2)
        await session_repository.create(logged_out_session)
        await session_repository.create(expired_session)
        
        # Act
        active_sessions = await session_repository.get_active_sessions_by_user_id(user_id)
    ...
    @pytest.mark.asyncio
    async def test_get_all_sessions_by_user_id(self, session_repository):
        ...
        await session_repository.create(other_session)
        
        # Act
        user_sessions = await session_repository.get_all_sessions_by_user_id(user_id)
    ...
    async def test_update_session(self, session_repository):
        ...
        # Act
        updated_session = await session_repository.update(logged_out_session)
        ...
        # Verify in database
        retrieved_session = await session_repository.get_by_id(created_session.id)
        assert retrieved_session.status == SessionStatus.LOGGED_OUT
    
    @pytest.mark.asyncio
    async def test_expire_sessions_by_user_id(self, session_repository):
        ...
        # Act
        expired_count = await session_repository.expire_sessions_by_user_id(user_id)
        
        # Assert
        assert expired_count == 2
        
        # Verify sessions are expired
        session1 = await session_repository.get_by_id(active_session1.id)
        session2 = await session_repository.get_by_id(active_session2.id)
        other = await session_repository.get_by_id(other_session.id)
        logged_out = await session_repository.get_by_id(logged_out_session.id)
    ...
    @pytest.mark.asyncio
    async def test_cleanup_expired_sessions(self, session_repository):
        ...
        await session_repository.create(expired_session1)
        await session_repository.create(expired_session2)
        await session_repository.create(logged_out_session)
        ...
        active = await session_repository.get_by_id(active_session.id)
        expired1 = await session_repository.get_by_id(expired_session1.id)
        expired2 = await session_repository.get_by_id(expired_session2.id)
        logged_out = await session_repository.get_by_id(logged_out_session.id)
    ...
    @pytest.mark.asyncio
    async def test_session_token_uniqueness(self, session_repository):
    ...
    async def test_delete_session(self, session_repository):
        ...
        # Act
        result = await session_repository.delete(created_session.id)
        
        # Assert
        assert result is True
        
        # Verify session is deleted
        deleted_session = await session_repository.get_by_id(created_session.id)
        assert deleted_session is None
    
    @pytest.mark.asyncio
    async def test_session_timestamps(self, session_repository):
        ...
        logged_out_session = created_session.logout()
        result = await session_repository.update(logged_out_session)
    ...
    @pytest.mark.asyncio
    async def test_domain_model_mapping(self, session_repository):
