...
from src.infrastructure.database.models import UserOrganizationRoleModel, UserModel, OrganizationModel, RoleModel
...
class TestUserOrganizationRoleRepositoryIntegration:
    ...
    def test_create_user_organization_role_in_database(self, db_session: Session, test_entities: dict):
        ...
        retrieved_role = db_session.query(UserOrganizationRoleModel).filter(
            UserOrganizationRoleModel.id == user_org_role.id
        ).first()
    ...
    def test_find_user_roles_in_organization(self, db_session: Session, test_entities: dict):
        ...
        user_roles = db_session.query(UserOrganizationRoleModel).filter(
    ...
    def test_revoke_user_role_in_database(self, db_session: Session, test_entities: dict):
    ...
    def test_reactivate_user_role_in_database(self, db_session: Session, test_entities: dict):
    ...
    def test_find_organization_users_with_role(self, db_session: Session, test_entities: dict):
        ...
        admin_users = db_session.query(UserOrganizationRoleModel).filter(
            UserOrganizationRoleModel.organization_id == organization.id,
    ...
    def test_role_assignment_audit_trail(self, db_session: Session, test_entities: dict):
