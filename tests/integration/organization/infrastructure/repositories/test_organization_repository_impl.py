...
# class TestSqlAlchemyOrganizationRepository:
#     """Integration tests for SqlAlchemyOrganizationRepository."""

#     @pytest.fixture
#     def organization_repository(self, db_session):
#         """Create SqlAlchemyOrganizationRepository instance with test database session."""
#         return SqlAlchemyOrganizationRepository(db_session)
