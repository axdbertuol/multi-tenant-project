...
class TestAuthUseCases:
    ...
    def mock_jwt_service(self):
        ...
        service.verify_token.return_value = Mock(user_id=uuid4(), email="test@example.com")
    ...
    @pytest.mark.asyncio
    async def test_signup_success(self, auth_use_cases, mock_uow):
        ...
        auth_use_cases.session_use_cases.create_session = AsyncMock(
            return_value=(Mock(), "test_token")
        )
        
        # Act
        result = await auth_use_cases.signup(
            signup_data, 
    ...
    @pytest.mark.asyncio
    async def test_signup_user_already_exists(self, auth_use_cases, mock_uow):
        ...
        with pytest.raises(ValueError, match="User with email existing@example.com already exists"):
            await auth_use_cases.signup(signup_data)
    
    @pytest.mark.asyncio
    async def test_login_success(self, auth_use_cases, mock_uow):
    ...
    @pytest.mark.asyncio
    async def test_login_user_not_found(self, auth_use_cases, mock_uow):
    ...
    @pytest.mark.asyncio
    async def test_login_inactive_user(self, auth_use_cases, mock_uow):
        ...
        with pytest.raises(ValueError, match="User account is deactivated"):
            await auth_use_cases.login(login_data)
    
    @pytest.mark.asyncio
    async def test_login_wrong_password(self, auth_use_cases, mock_uow):
    ...
    @pytest.mark.asyncio
    async def test_get_current_user_success(self, auth_use_cases, mock_uow, mock_jwt_service):
        ...
        auth_use_cases.session_use_cases.validate_session = AsyncMock(
        ...
        # Act
        result = await auth_use_cases.get_current_user(token)
    ...
    @pytest.mark.asyncio
    async def test_get_current_user_invalid_session(self, auth_use_cases):
    ...
    @pytest.mark.asyncio
    async def test_get_current_user_invalid_token(self, auth_use_cases, mock_jwt_service):
    ...
    @pytest.mark.asyncio
    async def test_get_current_user_inactive_user(self, auth_use_cases, mock_uow, mock_jwt_service):
        ...
        mock_jwt_service.verify_token.return_value = Mock(
            ...
            email=str(inactive_user.email.value)
        )
    ...
    @pytest.mark.asyncio
    async def test_verify_token_valid(self, auth_use_cases):
        ...
        # Act
        result = await auth_use_cases.verify_token(token)
        
        # Assert
        assert result is True
    
    @pytest.mark.asyncio
    async def test_verify_token_invalid(self, auth_use_cases):
    ...
    @pytest.mark.asyncio
    async def test_logout_success(self, auth_use_cases):
        """Test successful logout."""
        # Arrange
        token = "valid_token"
        
        # Mock session logout
        auth_use_cases.session_use_cases.logout_session = AsyncMock()
        
        # Act
        result = await auth_use_cases.logout(token)
    ...
    @pytest.mark.asyncio
    async def test_logout_failure(self, auth_use_cases):
        """Test logout failure."""
        # Arrange
        token = "invalid_token"
