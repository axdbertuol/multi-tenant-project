...
class TestUserUseCases:
    ...
    @pytest.mark.io
     def test_create_user_success(self, user_use_cases, mock_uow):
        ...
        # Act
        result = user_use_cases.create_user(create_dto)
    ...
    @pytest.mark.io
     def test_get_user_by_email_success(self, user_use_cases, mock_uow):
        ...
        # Act
        result = user_use_cases.get_user_by_email(email)
    ...
    @pytest.mark.io
     def test_get_all_users(self, user_use_cases, mock_uow):
        ...
        # Act
        result = user_use_cases.get_all_users()
    ...
    @pytest.mark.io
     def test_update_user_success(self, user_use_cases, mock_uow):
        ...
        # Act
        result = user_use_cases.update_user(user_id, update_dto)
    ...
    @pytest.mark.io
     def test_delete_user_success(self, user_use_cases, mock_uow):
        ...
        # Act
        result = user_use_cases.delete_user(user_id)
    ...
    @pytest.mark.io
     def test_deactivate_user_success(self, user_use_cases, mock_uow):
        ...
        # Act
        result = user_use_cases.deactivate_user(user_id)
    ...
    @pytest.mark.io
     def test_activate_user_success(self, user_use_cases, mock_uow):
        ...
        # Act
        result = user_use_cases.activate_user(user_id)
    ...
    @pytest.mark.io
     def test_change_password_success(self, user_use_cases, mock_uow):
        ...
        # Act
        result = user_use_cases.change_password(user_id, change_dto)
    ...
    @pytest.mark.io
     def test_change_password_wrong_old_password(self, user_use_cases, mock_uow):
        ...
        with pytest.raises(ValueError, match="Invalid old password"):
            user_use_cases.change_password(user_id, change_dto)
    ...
    @pytest.mark.io
     def test_verify_user_password_success(self, user_use_cases, mock_uow):
        ...
        # Act
        result = user_use_cases.verify_user_password(email, password)
