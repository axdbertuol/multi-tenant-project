...
class TestAuthUseCase:
    def setup_method(self):
        ...
        self.use_case = AuthenticationUseCase(self.mock_uow)
    ...
    def test_login_successful(self):
        ...
        user = User.create(email=dto.email, name="Test User", password=dto.password)
        ...
        with patch.object(
            self.use_case, "_generate_session_token", return_value="test_token_123"
        ):
    ...
    def test_refresh_session_successful(self):
        ...
        with patch.object(
            self.use_case, "_generate_session_token", return_value=new_token
        ):
    ...
    def test_request_password_reset_user_exists(self):
        ...
        user = User.create(email=dto.email, name="Test User", password="SecurePass123")
    ...
    def test_change_password_with_current_successful(self):
        ...
        user = User.create(
            email="test@example.com", name="Test User", password=current_password
        )
