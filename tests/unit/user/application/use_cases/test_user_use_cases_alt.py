...
class TestUserUseCase:
    def setup_method(self):
        ...
        # Create use case and inject mocked domain service
    ...
    def test_create_user_email_already_exists(self):
        ...
        dto = UserCreateDTO(
            email="existing@example.com", name="Test User", password="SecurePass123"
        )
        ...
        with pytest.raises(
            ValueError, match="Email existing@example.com is already in use"
        ):
    ...
    def test_get_user_by_email_found(self):
        ...
        user = User.create(email=email, name="Test User", password="SecurePass123")
    ...
    def test_update_user_successful(self):
        ...
        original_user = User.create(
            email="test@example.com", name="Original Name", password="SecurePass123"
        )
        ...
        self.mock_user_domain_service.validate_user_activation.return_value = (
            True,
            "Can be activated",
        )
    ...
    def test_change_password_successful(self):
        ...
        user = User.create(
            email="test@example.com", name="Test User", password=dto.current_password
        )
        user = user.model_copy(update={"id": user_id})
    ...
    def test_change_password_incorrect_current_password(self):
        ...
        user = User.create(
            email="test@example.com", name="Test User", password="CorrectPass123"
        )
        user = user.model_copy(update={"id": user_id})
    ...
    def test_deactivate_user_successful(self):
        ...
        self.mock_user_domain_service.validate_user_deactivation.return_value = (
            True,
            "Can be deactivated",
        )
        ...
        self.mock_user_domain_service.validate_user_deactivation.assert_called_once_with(
            user
        )
    ...
    def test_deactivate_user_validation_fails(self):
        ...
        with pytest.raises(
            ValueError, match="Cannot deactivate user: Cannot deactivate"
        ):
    ...
    def test_delete_user_successful(self):
        ...
        self.mock_user_domain_service.can_user_be_deleted.return_value = (
            True,
            "Can be deleted",
        )
        ...
        assert result is True
        self.mock_user_domain_service.can_user_be_deleted.assert_called_once_with(
            user_id
        )
    ...
    def test_list_users(self):
        ...
        self.mock_user_repository.list_active_users.assert_called_once_with(
            limit=10, offset=0
        )
    ...
    def test_check_email_availability(self):
        ...
        result = self.use_case.check_email_availability(
