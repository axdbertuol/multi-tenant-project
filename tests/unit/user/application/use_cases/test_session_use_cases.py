...
class TestSessionUseCase:
    ...
    def test_get_user_sessions(self):
        ...
        self.mock_session_repository.get_active_by_user_id.return_value = sessions

        result = self.use_case.get_user_sessions(user_id)

        assert len(result.sessions) == 3
        for i, session_dto in enumerate(result.sessions):
        ...
        self.mock_session_repository.get_active_by_user_id.assert_called_once_with(
            user_id
        )
    ...
    def test_get_active_user_sessions(self):
        ...
        self.mock_session_repository.get_active_by_user_id.return_value = [
            active_session
        ]
        ...
        assert result.sessions[0].session_token == "active_token"
    ...
    def test_revoke_session_successful(self):
        ...
        self.mock_session_repository.get_by_token.assert_called_once()
    ...
    def test_revoke_all_user_sessions(self):
        ...
        self.mock_session_repository.revoke_all_user_sessions.return_value = (
        ...
        self.mock_session_repository.revoke_all_user_sessions.assert_called_once_with(
            user_id
        )
    ...
    def test_extend_session_successful(self):
        ...
        result = self.use_case.extend_session(session.id, additional_hours)

        assert isinstance(result, SessionResponseDTO)
        # self.mock_session_repository.get_by_token.assert_called_once_with(session.id)
        self.mock_session_repository.save.assert_called_once()
    ...
    def test_extend_inactive_session(self):
        ...
        self.mock_session_repository.get_by_id.return_value = logged_out_session
    ...
    #     self.mock_session_repository.count_user_sessions.assert_called_once_with(
    #         user_id
    #     )
    ...
    #         user_id
    #     )
    #     self.mock_session_repository.count_active_user_sessions.assert_called_once_with(
    #         user_id
    #     )
    ...
    def test_cleanup_expired_sessions(self):
        ...
        self.mock_session_repository.cleanup_expired_sessions.return_value = (
        ...
        self.mock_session_repository.cleanup_expired_sessions.assert_called_once()
