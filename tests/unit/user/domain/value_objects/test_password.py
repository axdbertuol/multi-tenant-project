...
class TestPassword:
    ...
    def test_create_password_from_plain_text(self):
        ...
        password = Password.create("secureP@ssword123")

        assert password.hashed_value is not None
        assert len(password.hashed_value) > 0
        assert password.hashed_value != "secureP@ssword123"  # Should be hashed
    ...
    def test_password_verification_correct(self):
        ...
        assert password.verify("secureP@ssword123") is True
    ...
    def test_password_equality(self):
        ...
        password1 = Password.create("secureP@ssword123")
        password2 = Password.from_hash(password1.hashed_value)
        password3 = Password.create("diffsecureP@ssword123erent123")
    ...
    def test_password_unicode_characters(self):
        ...
        unicode_password = "secureP@ssword123á"
    ...
    def test_different_passwords_different_hashes(self):
        ...
        password1 = Password.create("secureP@ssword123")
        password2 = Password.create("secureP@sssword123")
    ...
    def test_same_password_different_hashes_due_to_salt(self):
        ...
        password1 = Password.create("secureP@ssword123")
        password2 = Password.create("secureP@ssword123")

        # Different hashes due to different salts
        assert password1.hashed_value != password2.hashed_value
        # But both verify correctly
        assert password1.verify("secureP@ssword123") is True
        assert password2.verify("secureP@ssword123") is True

    def test_password_with_exact_minimum_length(self):
        """Test password with exactly minimum length (8 characters)."""
        password = Password.create("s3cureP@")

        assert password.verify("s3cureP@") is True
        assert len("s3cureP@") == 8
