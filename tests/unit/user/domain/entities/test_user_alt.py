...
class TestUser:
    ...
    def test_update_name(self):
        ...
        user = User.create(
            email="test@example.com", name="Old Name", password="secureP@ssword123"
        )
    ...
    def test_deactivate_user(self):
        ...
        user = User.create(
            email="test@example.com", name="Test User", password="secureP@ssword123"
        )
    ...
    def test_change_password(self):
        ...
        old_password = "secureP@ssword123"
        new_password = "neWpasswor@d456"
    ...
    def test_user_equality(self):
        ...
        user1 = User.create(
            email="test1@example.com", name="User 1", password="secureP@ssword123"
        )

        user2 = User.create(
            email="test2@example.com", name="User 2", password="secureP@ssword121"
        )
