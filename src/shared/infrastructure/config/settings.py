...
class Settings(BaseSettings):
    ...
    jwt_refresh_expiration_hours: int = Field(default=24, env="JWT_REFRESH_EXPIRATION_HOURS")
    ...
    session_remember_me_hours: int = Field(default=720, env="SESSION_REMEMBER_ME_HOURS")  # 30 days
