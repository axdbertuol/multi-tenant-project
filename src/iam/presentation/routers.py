...
from .routes import auth_router, user_router, session_router, role_router, secure_auth_router

router = APIRouter(prefix="/api/v1/iam", tags=["IAM"])

# Include all IAM-related routes
router.include_router(auth_router, prefix="/auth", tags=["Authentication"])
router.include_router(secure_auth_router, tags=["Secure Authentication"])
